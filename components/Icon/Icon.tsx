...
const icons: { [key in IconType] } = {
  ...
  home: (styles) => (
    <svg viewBox="0 0 576 512" className={styles}>
      <path
        fill="currentColor"
  ...
  movies: (styles) => (
    <svg viewBox="0 0 512 512" className={styles}>
      <path
        fill="currentColor"
